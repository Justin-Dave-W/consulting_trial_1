declare module "wix-restaurants.v2" {
  ...
  interface BulkMenuOrderingSettingsResult {
      ...
      menuOrderingSettingsMetadata?: ItemMetadata$9;
  ...
  interface MenuOrderingSettingsQueryResult extends QueryCursorResult$b {
  ...
  interface ItemsQueryResult extends QueryCursorResult$a {
      items: Item[];
  ...
  interface LabelsQueryResult extends QueryCursorResult$9 {
      items: Label[];
  ...
  interface ModifiersQueryResult extends QueryCursorResult$8 {
      items: Modifier$1[];
  ...
  interface ModifierGroupsQueryResult extends QueryCursorResult$7 {
      items: ModifierGroup[];
  ...
  interface VariantsQueryResult extends QueryCursorResult$6 {
      items: Variant[];
  ...
  interface MenusQueryResult extends QueryCursorResult$5 {
      items: Menu[];
  ...
  interface BulkSectionResult {
      /** Whether to receive the updated sections in the response. */
      sectionMetadata?: ItemMetadata$3;
  ...
  interface SectionsQueryResult extends QueryCursorResult$4 {
      items: Section[];
  ...
  interface Operation$1 extends OperationOnlineOrderingStatusOptionsOneOf {
      ...
      /**
       * Location ID associated with the operation.
       * @internal
       */
  ...
  enum OnlineOrderingStatusType {
      ...
      DISABLED = "DISABLED",
      /** Operation currently does not accept online orders, but will accept online orders from a specifed time and date. When applied, `pausedUntilOptions` is a required field. */
  ...
  interface AvailabilityException {
       ...
       * To prevent conflicting changes, the current revision must be passed when updating the availability exception.
       * @readonly
       */
      revision?: string | null;
      /**
      ...
      /** ID of the [restaurant operation](/operations/introduction) this exception is associated with. */
      operationId?: string | null;
      /** Extended fields. */
