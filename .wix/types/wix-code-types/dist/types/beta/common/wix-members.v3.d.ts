declare module "wix-members.v3" {
  ...
  interface IncorrectPrivacyData {
      incorrectPrivacy?: Privacy$1;
      correctPrivacy?: Privacy$1;
  }
  ...
  type membersV1CustomFieldSuggestion_universal_d_Privacy = Privacy;
  const membersV1CustomFieldSuggestion_universal_d_Privacy: typeof Privacy;
  ...
  namespace membersV1CustomFieldSuggestion_universal_d {
    export {
      ...
      membersV1CustomFieldSuggestion_universal_d_Privacy as Privacy,
  ...
  /**
   * Marks member reports as reviewed.
   * @param memberId - ID of the member whose reports to be marked as reviewed.
   * @public
   * @documentationMaturity preview
