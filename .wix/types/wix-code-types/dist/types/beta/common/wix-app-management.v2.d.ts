declare module "wix-app-management.v2" {
  ...
  interface UsageBasedDetails {
      ...
      /**
       * Description of the usaged-based pricing plan, as defined in the [app dashboard](https://dev.wix.com/apps/my-apps?viewId=active-apps-view).
       *
       * Max: 1024 characters
       */
  ...
  interface SendBIEventRequest {
       ...
       * + `"APP_FINISHED_CONFIGURATION"`: The site owner completes all required configurations for your app in your app's dashboard.
