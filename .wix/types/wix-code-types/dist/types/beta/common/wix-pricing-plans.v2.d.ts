declare module "wix-pricing-plans.v2" {
  ...
  interface Pricing extends PricingPricingModelOneOf {
      ...
      freeTrialDays?: number | null;
      /**
       * Additional fees that would apply to the order. One of which could be a setup fee.
       * @internal
       */
  ...
  interface ListPlansRequest {
      ...
      planIds?: string[];
      /**
       * Plan name filter, also checks partial match
       * @internal
       */
      name?: string | null;
      /**
  ...
  /**
   * Returns count of plans for site
   * @internal
   * @documentationMaturity preview
   * @permissionId PRICING_PLANS.READ_PLANS
   * @adminMethod
  ...
  /**
   * Checks whether site has non-free plans and plans created before Pricing Plans became premium.
   * @internal
   * @documentationMaturity preview
   * @permissionId PRICING_PLANS.READ_PLANS
   * @adminMethod
