declare module "wix-review-requests.v2" {
  ...
  interface ReviewRequest extends ReviewRequestStatusOptionsOneOf {
      ...
      /**
       * Initiator of the review request
       * @readonly
       */
      initiator?: IdentificationData;
      /** Wix data extensions */
  ...
  interface ReviewRequestsQueryBuilder {
       ...
       * @documentationMaturity preview
       */
      eq: (propertyName: '_id' | '_createdDate' | 'sendDate' | 'namespace' | 'order.id' | 'items.catalogItemId' | 'items.reviewId' | 'recipient.contactId' | 'communicationChannel' | 'status' | 'automationActivationId' | 'initiator.wixUserId' | 'initiator.appId' | 'initiator.identityType', value: any) => ReviewRequestsQueryBuilder;
      /** @param propertyName - Property whose value is compared with `value`.
       * @param value - Value to compare against.
       * @documentationMaturity preview
       */
      ne: (propertyName: '_id' | '_createdDate' | 'sendDate' | 'namespace' | 'order.id' | 'items.catalogItemId' | 'items.reviewId' | 'recipient.contactId' | 'communicationChannel' | 'status' | 'automationActivationId' | 'initiator.wixUserId' | 'initiator.appId' | 'initiator.identityType', value: any) => ReviewRequestsQueryBuilder;
      /** @param propertyName - Property whose value is compared with `value`.
       * @param value - Value to compare against.
       * @documentationMaturity preview
       */
      ...
      /** @documentationMaturity preview */
      in: (propertyName: '_id' | '_createdDate' | 'sendDate' | 'namespace' | 'order.id' | 'items.catalogItemId' | 'items.reviewId' | 'recipient.contactId' | 'communicationChannel' | 'status' | 'automationActivationId' | 'initiator.wixUserId' | 'initiator.appId' | 'initiator.identityType', value: any) => ReviewRequestsQueryBuilder;
      /** @documentationMaturity preview */
  ...
  /**
   * Updates extended fields of a ReviewRequest without incrementing revision
   ...
   * @permissionId REVIEWS.REVIEW_REQUEST_UPDATE
   * @adminMethod
   */
  ...
  type reviewsV2ReviewRequest_universal_d_CountReviewRequestsRequest = CountReviewRequestsRequest;
  type reviewsV2ReviewRequest_universal_d_CountReviewRequestsResponse = CountReviewRequestsResponse;
  type reviewsV2ReviewRequest_universal_d_BulkCancelReviewRequestRequest = BulkCancelReviewRequestRequest;
  type reviewsV2ReviewRequest_universal_d_BulkCancelReviewRequestResponse = BulkCancelReviewRequestResponse;
  type reviewsV2ReviewRequest_universal_d_UpdateExtendedFieldsRequest = UpdateExtendedFieldsRequest;
  type reviewsV2ReviewRequest_universal_d_UpdateExtendedFieldsResponse = UpdateExtendedFieldsResponse;
  ...
  const reviewsV2ReviewRequest_universal_d_countReviewRequests: typeof countReviewRequests;
  type reviewsV2ReviewRequest_universal_d_CountReviewRequestsOptions = CountReviewRequestsOptions;
  const reviewsV2ReviewRequest_universal_d_bulkCancelReviewRequest: typeof bulkCancelReviewRequest;
  type reviewsV2ReviewRequest_universal_d_BulkCancelReviewRequestOptions = BulkCancelReviewRequestOptions;
  const reviewsV2ReviewRequest_universal_d_updateExtendedFields: typeof updateExtendedFields;
  type reviewsV2ReviewRequest_universal_d_UpdateExtendedFieldsOptions = UpdateExtendedFieldsOptions;
  namespace reviewsV2ReviewRequest_universal_d {
    export {
      ...
      reviewsV2ReviewRequest_universal_d_CountReviewRequestsRequest as CountReviewRequestsRequest,
      reviewsV2ReviewRequest_universal_d_CountReviewRequestsResponse as CountReviewRequestsResponse,
      reviewsV2ReviewRequest_universal_d_BulkCancelReviewRequestRequest as BulkCancelReviewRequestRequest,
      reviewsV2ReviewRequest_universal_d_BulkCancelReviewRequestResponse as BulkCancelReviewRequestResponse,
      reviewsV2ReviewRequest_universal_d_UpdateExtendedFieldsRequest as UpdateExtendedFieldsRequest,
      reviewsV2ReviewRequest_universal_d_UpdateExtendedFieldsResponse as UpdateExtendedFieldsResponse,
      ...
      reviewsV2ReviewRequest_universal_d_countReviewRequests as countReviewRequests,
      reviewsV2ReviewRequest_universal_d_CountReviewRequestsOptions as CountReviewRequestsOptions,
      reviewsV2ReviewRequest_universal_d_bulkCancelReviewRequest as bulkCancelReviewRequest,
      reviewsV2ReviewRequest_universal_d_BulkCancelReviewRequestOptions as BulkCancelReviewRequestOptions,
      reviewsV2ReviewRequest_universal_d_updateExtendedFields as updateExtendedFields,
      reviewsV2ReviewRequest_universal_d_UpdateExtendedFieldsOptions as UpdateExtendedFieldsOptions,
    };
  }
