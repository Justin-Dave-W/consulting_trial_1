declare module "wix-router" {
     ...
     */
    function ok(Page: string | string[], routerReturnedData?: any, head?: WixRouterResponse.HeadOptions, options?: Options): Promise<WixRouterResponse>;
    /**
    ...
    export { Cache, Options, WixDataQuery, WixRouterRequest, WixRouterResponse, WixRouterSitemapEntry, WixRouterSitemapRequest, WixRouterUser, afterRouter, afterSitemap, beforeRouter, customizeQuery, forbidden, next, notFound, ok, redirect, router, sendStatus, sitemap };
}
