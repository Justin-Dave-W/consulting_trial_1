...
// ../cli-logger/src/index.ts
init_esm_shims();

// ../cli-logger/src/create-logger.ts
init_esm_shims();
...
function createLogger() {
  return {
    ...
    logWithLoader: (messageOrOptions) => {
      const initialOptions = typeof messageOrOptions === "string" ? { text: messageOrOptions } : messageOrOptions ?? {};
      const options = {
        ...initialOptions,
        discardStdin: false,
        isEnabled: true,
      ...
      const loader = ora(options).start();
      return {
        update: (message) => {
          loader.text = message;
        },
...
//# sourceMappingURL=chunk-CNXKF7E3.js.map